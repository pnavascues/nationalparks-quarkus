...
/*         String mongoHost = env.getProperty("mongodb.server.host", "127.0.0.1"); // env var MONGODB_SERVER_HOST takes precedence
        ...
        String mongoUri = "";
        String mongoUser = "mongodb";
        String mongoPassword = "mongodb";
        String mongoDBName = "mongodb";
        String dbServiceName ="mongodb";
    ...
    public List<Park> getAll() {
        ...
        if (mongoDB != null) {
            try {
                ...
                try {
                    ParkReadConverter<DBObject,Park> converter = new ParkReadConverter<DBObject,Park>();
                    while (cursor.hasNext()) {
                        allParksList.add(converter.convert((Document)cursor.next()));
                    }
                } finally {
                    cursor.close();
                }
